...
criterion. Those moves are free to scatter nickel across the three-phase
junction, and that is what inflates the junction count. An area budget does not
constrain the degree of freedom that governs TPB.
...
scattering nickel across the three-phase junction. A monotone-area gate cannot
detect this, because the area genuinely does decrease while the microstructure
degrades in a way the criterion does not measure.
...
project repository \texttt{voxel-damage-operators-niysz}. Every number in this paper
