...
The fourth failure mode is in the same runs, and it inverts the quantity the
...
and strict area monotonicity, and---the one that changed a headline
result---a neighbour count taken with a structuring element that includes the
...
none---are logged in the run reports at the point where each was found. Two
