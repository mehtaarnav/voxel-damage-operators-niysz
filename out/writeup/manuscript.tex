...
and on all three real electrodes it passes the strict-decrease gate. It fails
...
there. Of the six in Table~\ref{tab:modes}, that model is exposed to none. It
...
\item Enforcing monotone surface-area reduction as a validity criterion
  ...
  area criterion it is validated against. The criterion and the mechanism
