...
\item Neither pristine topology nor specific nickel surface area predicts the
  measured ordering. The coarse anode carries the smallest minimum cut of the
  three, 2.8 times below fine and 4.1 times below medium on class means, and
  is the best retainer in service.
