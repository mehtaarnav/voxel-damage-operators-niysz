...
this work either supports or excludes it. What we can say is narrower and
firmer. No operator of this class thinned a neck at any intensity, seed, move
budget or acceptance rule tried, including a strictly area-lowering rule and a
finite-temperature one, so the anticorrelation stands as an open puzzle that
this class of method is not equipped to pose, let alone answer.
